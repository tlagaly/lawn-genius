...
class NotificationService {
    static async logNotification(options, status, error) {
    ...
    static async getEmailTemplate(alert) {
    ...
    static async sendEmailNotification(userId, alert) {
        try {
            ...
            await this.logNotification({ userId, alertId: alert.id, type: 'email' }, 'sent');
            ...
            await this.logNotification({ userId, alertId: alert.id, type: 'email' }, 'failed', error instanceof Error ? error.message : 'Unknown error');
            throw error;
        }
    }
}
